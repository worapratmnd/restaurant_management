declare namespace NodeJS {
  export interface ProcessEnv {
    ...
    readonly MYSQL_DATABASE_HOST: string!;
    readonly MYSQL_DATABASE_PORT: string!;
    readonly MYSQL_DATABASE_USER: string!;
    readonly MYSQL_DATABASE_PASSWORD: string!;
    readonly MYSQL_DATABASE_NAME: string!;
    readonly MYSQL_DATABASE_DIALECT: string!;
